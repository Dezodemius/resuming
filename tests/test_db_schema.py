...
_EXPECTED_COLUMNS = {
    ...
    "ai_prompt_buffer": ["created", "id", "prompt"],
    "legal_events": ["action", "correlation_id", "document_hash", "document_rev", "id",
                     "metadata", "occurred_at", "purpose", "user_id"],
    "magic_tokens": ["created", "email", "expires_at", "terms_accepted", "terms_hash",
                     "terms_rev", "token", "used"],
    ...
    "users": ["ai_consent_at", "ai_consent_hash", "ai_consent_rev", "created", "display_name", "email",
              "free_left", "id", "is_pro", "paid_left", "pro_expires_at", "terms_accepted_at",
              "terms_hash", "terms_rev"],
}

_EXPECTED_INDEXES = [
    "idx_ai_prompt_buffer_created",
    "idx_anon_created",
    ...
    "idx_legal_events_correlation",
    "idx_legal_events_user_created",
    "idx_magic_expires",
